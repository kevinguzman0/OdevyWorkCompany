		    ...
		    <div class="modal-dialog" role="document">
		        ...
		        <div class="modal-content">
		            ...
		            <div class="modal-header">
		                ...
		                <h6 class="modal-title">Id producto [ {{ $item->id }} ]</h6>
		            ...
		            <div class="modal-body">
		                ...
		                <div class="modal-body-descripcion">
		                    <h6 class="modal-title" id="modal_body_descripcion">{{ $item->name }}</h6>
		                </div>
		            ...
		            <div class="modal-footer">
		            	@auth
                        	<button type="button" class="btn btn-success" data-dismiss="modal" onclick="location.href = '{{ route('carrito.agregar', [ $item->id]) }}'">Comprar</button>
